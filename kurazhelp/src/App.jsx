...
const handleAIMessage = async (message, mode = 'chat') => {
  ...
  if (documents.length === 0) {
    return (
      <div className={`flex h-screen bg-gray-900 text-gray-100 items-center justify-center flex-col ${isDarkMode ? 'dark' : 'light'}`}>
  ...
  return (
    <div className={`flex h-screen font-sans ${isDarkMode ? 'dark bg-gray-900 text-gray-100' : 'light bg-gray-100 text-gray-900'}`}>
      <Sidebar
        documents={documents}
